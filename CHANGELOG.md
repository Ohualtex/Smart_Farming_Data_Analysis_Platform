...
## [Unreleased] — `shiftFinal` kapanışı + `REBUILD` Faz 1
...
ilk faz (4-rol RBAC + per-user data isolation) tamamlandı. Bölüm
açık kalır; REBUILD Faz 2 commit'leri buraya eklenmeye devam edecek.
