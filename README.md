...
![Tests 220](https://img.shields.io/badge/Tests-220%20passed-success)
...
| 🗄️ Migration | Alembic env.py konfigürasyonu hazır (14 tablo); initial migration Cycle 8'de üretilecek |
...
| 📡 IoT/MQTT stream simülasyonu + sensör arşivleme | Cycle 7 | Emirhan |
| 📊 Model performans dashboard'u | Cycle 7 | Mehmet |
...
> Cycle 8'de JWT (`python-jose` + `passlib[bcrypt]`) ile değiştirilecek.
...
|:-------|:------|
| Toplam Test | 220 |
| Coverage | %86 (eşik %80, Cycle 8 hedefi %95) |
...
├── tests/                       # 220 test (19 dosya, %86 coverage)
...
| Cycle 7 | 3 – 10 Mayıs | ⏳ Planlandı |
| Cycle 8 | 11 – 20 Mayıs | ⏳ Üretim hazırlığı, güvenlik, cila |
| Cycle 9 | 21 – 31 Mayıs | ⏳ Final rapor ve akademik teslim |
