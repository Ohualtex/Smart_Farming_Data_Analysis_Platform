/* ============================================================
   SFDAP — Filiz Maskotu Modülü
   ============================================================
   Welcome ekranı pop animasyonu (popFiliz), rol-aware ipucu
   havuzları + selamlamalar, mood yönetimi ve maskot etkileşimi
   (göz takibi, konuşma balonu, critical alert yansıması).
   Leaf-lib: yalnızca api + session okur, sayfa modüllerine bağımlı değil.
   ============================================================ */
...
export function _getRoleTips(role) {
    switch (role) {
...
export function pickFilizGreetings() {
...
export function setFilizMood(mood) {
    filizMood = mood;
